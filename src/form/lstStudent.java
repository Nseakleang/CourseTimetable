 ...
 * @author Chenhai
 */
public class lstStudent extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jlFacultyName.setText("Student Name");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Student ID", "Student Name", "Sex", "Contact", "Address", "Department", "Degree", "GroupYear", "Group Class", "Status"
            }
        ));
    ...
    private void jbtAddNewMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jbtAddNewMouseClicked
        Student.getInstance().setVisible(true);
